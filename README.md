...
Right before MPhil started I did an internship at the HK Department of Health. It was my first ever internship, and it was related to my then future (i.e. current) field of study, so I was really excited about it. Into an unknown abyss for me I was shipped into the Wastewater Surveillance section within the Centre for Health Protection, and this following mini-project I did wasn't exactly planned, but wrapped up my rather interesting time there. Here I decided to make public of my work because why not, it's based on publicly available data anyway, and DH doesn't have a dashboard for visualization so here goes.
